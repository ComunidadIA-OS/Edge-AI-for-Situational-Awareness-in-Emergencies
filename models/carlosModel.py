...
client = InferenceHTTPClient.init(
    ...
    api_key="onfYfpj9moxRi8s99jn9",
)

source = VideoFileSource("models/3-WhiteHot.mov", realtime_processing=False)  # Buffer and process all frames

VIDEO_OUTPUT = "output_image"
DATA_OUTPUTS = ["count_objects","predictions"]
...
session = client.webrtc.stream(
    ...
    workspace="carloss-workspace-1vmsh",
    image_input="image",
    config=config
)
